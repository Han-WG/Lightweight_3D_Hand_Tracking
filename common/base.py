...
from data.InterHand26M.dataset import Dataset
...
class Trainer(Base):
    ...
    def save_model(self, state, epoch):
        ...
        # file_path = osp.join(cfg.model_dir, 'snapshot.pth')
    ...
    def load_model(self, model, optimizer):
        ...
        cur_epoch = max(
            [int(file_name[file_name.find('snapshot_') + 9: file_name.find('.pth')]) for file_name in model_file_list])
